/**
 * Set payment token for APEX (ERC-8183) contract
 * Usage: NEW_PAYMENT_TOKEN=0x... npx hardhat run scripts/apex-set-payment-token.ts --network bscTestnet
 */
...
async function main() {
  ...
  console.log("Set ERC-8183 Payment Token");
  console.log("=".repeat(60));
  console.log("Network:", connection.networkName);
  console.log("Deployer:", deployer.account.address);
  console.log("ERC-8183 Contract:", PROXY_ADDRESS);
